...
class TopicModel(Query):
	...
	def get_all_topics(self, num = 15, current_page = 1):
	...
	def get_all_topics_by_node_slug(self, num = 15, current_page = 1, node_slug = None):
	...
	# def get_node_topics_count(self, node_slug = None):
	# 	where = "node.slug ='%s'" % node_slug
	# 	group = "node"
	# 	return self.where(where).count()

	def get_user_all_topics(self, uid, num = 15, current_page = 1):
	...
	def get_user_all_replied_topics(self, uid, num = 15, current_page = 1):
